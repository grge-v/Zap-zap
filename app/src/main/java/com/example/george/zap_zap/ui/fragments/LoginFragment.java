...
import com.example.george.zap_zap.core.login.LoginContract;
import com.example.george.zap_zap.core.login.LoginPresenter;
import com.example.george.zap_zap.ui.activites.RegisterActivity;
...
public class LoginFragment extends Fragment implements View.OnClickListener, LoginContract.View {
    ...
    public void onLoginSuccess(String message) {
        ...
        Toast.makeText(getActivity(), "Записан успешно: ", Toast.LENGTH_SHORT).show();
