package com.example.george.zap_zap.core.login;
...
import com.example.george.zap_zap.utils.SharedPrefUtil;
        ...
        FirebaseAuth.getInstance()
                ...
                .addOnCompleteListener(activity, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        // Если сбой входа, отобразит сообщение пользователю.
                        // слушатель состояния auth будет уведомлен
                        // подписанный пользователь может обрабатываться в слушателе.
