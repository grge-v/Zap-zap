package com.example.george.zap_zap.ui.fragments;
...
import com.example.george.zap_zap.core.users.getall.GetUsersContract;
import com.example.george.zap_zap.core.users.getall.GetUsersPresenter;
import com.example.george.zap_zap.models.User;
import com.example.george.zap_zap.ui.activites.ChatActivity;
import com.example.george.zap_zap.ui.adapters.UserListingRecyclerAdapter;
import com.example.george.zap_zap.utils.ItemClickSupport;
...
public class UserFragment extends Fragment implements GetUsersContract.View, ItemClickSupport.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void bindViews(View view) {
        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.swipe_refresh_layouts);
